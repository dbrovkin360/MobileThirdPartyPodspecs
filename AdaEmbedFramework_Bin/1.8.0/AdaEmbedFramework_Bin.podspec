Pod::Spec.new do |spec|
  ...
  spec.name         = "AdaEmbedFramework_Bin"
  spec.version      = "1.8.0"
  ...
  spec.vendored_framework = 'AdaEmbedFramework.xcframework'
  spec.source = { :http => 'https://github.com/AdaSupport/ios-sdk/releases/download/%s/AdaEmbedFramework.xcframework.zip' % [spec.version]}
end